from regression import LinReg, train_linear_reg, EncryptedLinearRegression, train_encrypted_linear_reg
...
def run_experiment(normalization_type):
    x_train, y_train, x_test, y_test = get_financial_data(standardization=normalization_type)
    ...
    train_encrypted_linear_reg(encrypted_model, ctx_training, enc_x_train, enc_y_train, x_test, y_test)
